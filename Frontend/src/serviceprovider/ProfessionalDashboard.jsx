        ...
        <div className="lg:col-span-4 space-y-6">
          <div className="bg-white p-8 rounded-[40px] border border-slate-100 shadow-sm space-y-6">
            <h4 className="font-black text-xs uppercase tracking-widest text-slate-900 flex items-center gap-2">
              <Cpu size={16} className="text-teal-600" /> System Diagnostics
            </h4>
            <div className="space-y-4">
              ...
              <div className="flex justify-between items-center text-sm">
                ...
                <span className="text-teal-600 font-black">LEVEL 5</span>
              </div>
              <div className="h-1.5 w-full bg-slate-100 rounded-full overflow-hidden">
        ...
        <header className="sticky top-0 z-40 bg-white/60 backdrop-blur-2xl border-b border-slate-200 px-8 py-5 flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            <button className="relative p-2 text-slate-400 hover:text-slate-900 transition-colors group">
              <Bell size={20} />
              <div className="absolute top-2 right-2 h-2 w-2 bg-teal-500 rounded-full border-2 border-white"></div>
            </button>
            <div className="flex items-center gap-3 pl-6 border-l border-slate-200">
              <div className="w-10 h-10 rounded-[14px] bg-teal-50 border border-teal-100 flex items-center justify-center text-teal-600 font-black text-xs shadow-sm shadow-teal-100">
                PRO
              </div>
            </div>
          </div>
